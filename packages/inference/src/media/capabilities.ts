...
import { TimeoutError, withTimeout } from "../shared/timeout";
...
export type AiCapabilityRuntime<Binding = AudioTranscriptionBinding & AudioSpeechBinding & ImageGenerationBinding> = {
  workersAi?: Binding;
...
export async function transcribeAudio(
  runtime: AiCapabilityRuntime<AudioTranscriptionBinding>,
...
export async function synthesizeSpeech(
  runtime: AiCapabilityRuntime<AudioSpeechBinding>,
...
export async function generateImage(
  runtime: AiCapabilityRuntime<ImageGenerationBinding>,
...
function isWorkersAiProvider(provider: string): boolean {
  return provider === "workers-ai" || provider === "workersai";
}
