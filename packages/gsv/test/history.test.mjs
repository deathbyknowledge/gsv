...
const eventFixtures = {
  ...
  "social.message": { eventId: "social:one", scopeId: "scope:one", conversationId: "conversation:one", contactId: "contact:one",
    mode: "draft", ownerRequest: "Prepare a private reply", reference: { actor: { shipId: "ship:remote", subjectId: "subject:remote" }, messageId: "origin:one" },
    message: { sender: "Sam", text: "An incoming question", contentTrust: "untrusted", attachmentsIncluded: false } },
