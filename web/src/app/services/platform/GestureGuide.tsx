...
export const gestureLessons: readonly { id: GestureLesson; key: string; action: string; hint: string; image: string }[] = [
  { id: 1, key: "1", action: "Listen / pause", hint: "Pause keeps your draft.", image: "One finger or thumb extending, then returning to a fist" },
  { id: 2, key: "2", action: "Send", hint: "Keep listening after sending.", image: "Two fingers extending, then returning to a fist" },
  { id: 3, key: "3", action: "Delete", hint: "Last dictated character.", image: "Three fingers extending, including an example with the thumb" },
