...
The shared header contains the wordmark and navigation. Helper conversations keep their label and return-to-Ship action in navigation. Fleet presents Places, Processes, Contacts, Ledger and Files in reading order.
