...
const GSV_PLAIN_SURFACES: ShellSurfaceId[] = ["files", "repositories", "library", "terminal", "architecture", "runtime", "responsibilities", "contacts"];
...
const GSV_RAIL_ITEMS: { label: string; surface: ShellSurfaceId }[] = [
  ...
  { label: "SYSTEM MAP", surface: "architecture" },
