...
import { DataCard, type DataCardRow } from "../../../../app/components/ui/DataCard";
import { ListCard, type ListCardRow } from "../../../../app/components/ui/ListCard";
import { OBJECT_GLYPH_ICON } from "../../../../app/components/ui/objectGlyph";
import { SectionHeader } from "../../../../app/components/ui/SectionHeader";
import type { StatusTone } from "../../../../app/components/ui/StatusDot";
import type { TagTone } from "../../../../app/components/ui/Tag";
import { fixedAiProviderModel } from "../../../../app/domain/aiProviders";
import {
  configValueForKey,
  editableModelSource,
...
} from "../../../../app/domain/system/consoleSettings";
import {
  type AgentApprovalAction,
  behaviorForAccount,
  parseApprovalPolicy,
} from "../../../../app/domain/system/consoleAgentBehavior";
import { modelProfilesForConfig, overrideConfigCount } from "../../../../app/domain/system/consoleAi";
import { useConsoleAgentContext, useConsoleModels } from "../../../../app/services/system/useConsoleData";
import type { ConsoleListKind } from "../domain/consoleListTypes";
import {
  avatarForAccount,
  isConsoleAgentAccount,
  orderedCrewAccounts,
} from "../../../../app/domain/system/agentPresentation";
import type {
  ConsoleAccount,
  ConsoleAdapter,
...
import { consoleWorkProcesses } from "../../../../app/domain/system/consoleProcesses";
import type { ShellSurfaceId } from "../../desktop/domain/shellModel";
import {
  processSub,
  statusForProcess,
  toneForProcess,
...
import {
  ...
  iconForAdapterName,
  messengerFamilies,
} from "../../../../app/features/instrument/settings/messengers/messengerPresentation";
