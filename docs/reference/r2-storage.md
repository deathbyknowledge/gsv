...
| `public/gsv/downloads/cli/default-channel.txt` | `sys.bootstrap`, `sys.update`, Kernel version refresh | Default CLI release channel. |
| `public/gsv/downloads/cli/install.{sh,ps1}` | `sys.bootstrap`, `sys.update`, Kernel version refresh | Static CLI install scripts served through `/public/*`. |
