...
import { PROCESS_AI_CONFIG_STORE_KEY, parseProcessAiConfig } from "../ai-config";
import type { ProcAiConfig, ProcContextState, ProcUsageState } from "@humansandmachines/gsv/protocol";
...
export class ProcessStateRepository {
  ...
  getAiConfig(): ProcAiConfig | null {
    return this.parseValue(PROCESS_AI_CONFIG_STORE_KEY, parseProcessAiConfig);
  }
