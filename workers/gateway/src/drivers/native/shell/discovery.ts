...
const NATIVE_COMMAND_DESCRIPTORS = defineNativeCommandDescriptors({
  ...
  web: command("Search the web and return source links and excerpts.", "Find current information and sources through the configured web search service.", ["web", "internet", "search", "sources", "research", "news"], [], ["web search [--limit 1..10] [--include-domain HOST] [--exclude-domain HOST] [--json] QUERY..."], ["web.search"]),
