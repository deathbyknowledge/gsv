...
async fn test_read_tool() {
    use machine::tools::{ReadTool, Tool};
    use serde_json::json;
    use std::io::Write;
...
async fn test_write_tool() {
    use machine::tools::{Tool, WriteTool};
    use serde_json::json;
...
async fn test_edit_tool() {
    use machine::tools::{EditTool, Tool};
    use serde_json::json;
    use std::io::Write;
...
async fn test_search_tool() {
    use machine::tools::{SearchTool, Tool};
    use serde_json::json;
    use std::io::Write;
...
fn test_all_tools_with_workspace() {
    use machine::tools::all_tools_with_workspace;
