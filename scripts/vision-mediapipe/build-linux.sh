...
readonly PATCH_SHA256="6d5040fe7698bb983c1766e851efe12298467f6adf8cd0d3c922fc17fd0368e8"
readonly BZLMOD_LOCK_SHA256="0197909a04fbfd5b765d0a2e402496885ec1a6cc850f76fa34dfa454dc94563f"
...
for command_name in awk c++ cmake cmp curl diff flock git grep install make mktemp nice nm patchelf readelf sed sha256sum sort tr unzip; do
...
(
  ...
  sha256sum \
    ...
    model/gesture_recognizer.task >ARTIFACTS.sha256
)
