/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8c13f9a776aaeb1d4b89d0f23956f111)
// Runtime types generated with workerd@1.20260415.1 2026-01-28 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		CODEMODE_OUTBOUND: Service<typeof import("./src/index").CodeModeOutbound> /* entrypoint CodeModeOutbound from gsv */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RIPGIT_INTERNAL_KEY" | "GSV_TEST_OPENAI_KEY">> {}
}
