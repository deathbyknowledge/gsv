...
const README = [
  ...
  "  media record uses tabCapture; when Chrome refuses, ask the person to focus the tab, open Your GSV from the toolbar and choose Allow recording, then retry.",
  "  each allowance starts one media record start.",
