...
const README = [
  ...
  "  tabs open can open URLs, browser target files, target-qualified files, or stdin in a viewer tab.",
  ...
  "  media record uses tabCapture and may require opening the GSV extension UI for the target tab first.",
  "  media record keeps tab audio audible by default; use --monitor off to disable playback.",
